const CACHE="fitness-tracker-pwa-v4-2";
const SHELL=["./","./index.html","./css/style.css","./js/config.js","./js/supabase.js","./js/storage.js","./js/app.js","./manifest.json","./icons/icon-180.png","./icons/icon-192.png","./icons/icon-512.png","./assets/coach-avatar.png"];
